        ...
        <div className='flex items-center justify-center w-full my-16'>
            <div className='flex justify-center flex-col w-[95%]'>
                <div className='flex flex-col gap-4 justify-center items-center'>
                    <h3 className='text-2xl md:text-4xl font-serif font-bold'>About HOPPY</h3>
                </div>
                <div className='flex flex-col w-full justify-center items-center gap-8'>
                    <div className="w-[70%] mt-8 p-5 bg-[#63681e] rounded-2xl gap-8 flex flex-col">
                        <p>Hoppy is a community-driven creative brand and blockchain-powered ecosystem inspired by internet culture, art, and storytelling. We blend digital innovation with real-world products and experiences, building a global community around creativity, entertainment, and utility.</p>
